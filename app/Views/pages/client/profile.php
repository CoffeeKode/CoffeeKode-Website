    ...
    <div class="row d-flex justify-content-center">
        ...
        <div class="col-md-10">
            <div class="card">
                ...
                <form id="form-profile" action="/mi-perfil" method="post">
                    <input value="update_user" name="update" style="display: none;">
    ...
    <div class="modal-dialog modal-notify modal-amber modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-center">
                <div class="row">
                    <div class=" col-md-6 ">
                        <a href="#" onclick="$('#form-profile').submit()" class="btn btn-info btn-rounded waves-effect text-white">Guardar
...
<script>
    function load_commune() {
        ...
        $.getJSON('get_commune', function(result) {
            ...
            mySelect.append("<option disabled selected >Selecciona tu comuna</option>");
